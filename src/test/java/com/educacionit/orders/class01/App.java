...
public class App {
    ...
    public static void main (String[] args) {
        ...
        e1.send ("Homer Simpson", "Lisa Simpson", "Interfaces", "My first interface");

        e1 = new PushNotification();
        e1.send ("Bart Simpson", "Magie Simpson", "Interfaces", "My first interface");
        ...
        e2.send ("Maggie Simpson", "Marge Simpson", "Interfaces", "My first interface");


        // LAMBDA EXPRESSIONS.
        INotification e3 = (String to, String from, String subject, String content) -> {
                System.out.println (String.format ("%s sending message [%s][%s] to %s using lambda expressions !!!", from, subject, content, to));
        };
        e3.send ("Maggie Simpson", "Marge Simpson", "Interfaces", "My first interface");
        ...
        e5.send ("Moe", "Barney", "Interfaces", "My first interface");


        // INNER CLASS.
        INotification e6 = new App().new BirdNotification();
        e6.send ("Apu", "Barney", "Interfaces", "My first interface");
        ...
        e7.send ("Barney", "Mou", "Interfaces", "My first interface");
    }
}